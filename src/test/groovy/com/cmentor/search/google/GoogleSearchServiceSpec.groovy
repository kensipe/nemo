 ...
 * @author kensipe
 */
class GoogleSearchServiceSpec extends Specification {
    ...
    GoogleSearchService searchService = new GoogleSearchService();
        ...
        def "json to link results"() {
            given:
            def internalSearch = Mock(GoogleInternalSearchService)
            searchService.searchService = internalSearch
            internalSearch.search("") >> conjureGoogleJson()
